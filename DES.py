...
# Final Permutation
final_block = R + L # Note: R and L are swapped before final permutation
plain = permute(final_block, PI)

# Convert Binary to ASCII
chars = [chr(int(plain[i:i+8], 2)) for i in range(0, 64, 8)]
plaintext_ascii = ''.join(chars)

print("\nFinal Result")
print(f"Plaintext (binary): {plain}")
